...
# Your code below:
square = None  # Lambda to square a number
add = None  # Lambda to add two numbers
is_even = None  # Lambda to check if even
...
result = create_profile(name="Alice", age=25, city="NYC")
if result is not None:
    print(result)
